...
export type VisualScene = {
  ...
  title: string;
  description: string;
  imagePlaceholder: string; // Describes the image you will eventually add
};
    ...
    visuals: [
      {
        ...
        imagePlaceholder: "Visual of a broken crown and a sick body, representing the rebellion of Israel."
      },
      {
        startVerse: 10,
        title: "Jehovah Hates Formalistic Worship",
        description: "Verses 10-17",
        imagePlaceholder: "Visual of a temple altar with smoke turning black/rejected, contrasting with hands washing clean."
      },
      {
        startVerse: 18,
        title: "“Let Us Set Matters Straight”",
        description: "Verses 18-20",
        imagePlaceholder: "Visual of a bright red scarlet cloth transforming into pure white wool/snow."
      },
      {
        startVerse: 21,
        title: "Zion to be Restored",
        description: "Verses 21-31",
        imagePlaceholder: "Visual of a smelting fire refining gold, with a glowing city in the background."
      }
    ],
    verses: [
      {
